        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <form action="{{ URL::to('/shop') }}" method="GET" class="d-flex">
    <input type="search" name="search" class="form-control mt-1" placeholder="Search" value="{{ request('search') }}">
    <button class="btn btn-dark ml-2 mt-1 text-white" type="submit">Search</button>
    <a href="{{ URL::to('/shop') }}">
